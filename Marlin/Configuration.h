...
#define STRING_CONFIG_H_AUTHOR "Tom Marsh" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TildArcBot"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 338.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 116.55 //mm  Get this value from auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7250, 7250, 7250, 1000 }
...
//#define Y_PROBE_OFFSET_FROM_EXTRUDER 42.0   // Y offset: -front +behind [the nozzle]
